<x-main-layout>
    ...
    <section class="text-center" style="padding-top:10rem;padding-bottom:10rem;" id="">
    ...
    <g id="small">
      ...
      <animateTransform
        ...
        <a href="mailto:email">ulogram.id@gmail.com</a>
        </div>

        <p class="footer"><img src="img/ulogram.png" width="50px">Ulogram</p>
