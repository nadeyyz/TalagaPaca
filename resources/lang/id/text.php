...
return [
    ...
    'konten_jumbotron' => 'Jelajahi keindahan yang memukau di Talaga Paca, Indonesia! 🌴 Nikmati keindahan alam dari permata tersembunyi ini. Terbawa oleh pesona danau alami, hutan lebat, dan budaya yang kaya. Baik Anda mencari petualangan atau ketenangan, Talaga Paca memiliki semuanya. Rencanakan liburan Anda hari ini dan buat kenangan tak terlupakan di surga Indonesia ini!',
    'pelajari'=> 'Pelajari Lebih',
    'populer' => 'Tempat Populer',
    'selengkapnya' => 'Selengkapnya',
    'about' => 'Tentang Desa Talaga Paca',
    'konten_about' => 'Desa Talaga Paca terdiri dari 210 kepala keluarga, 95% memiliki matapencaharian utama sebagai petani. Sebelum tahun 1980-an, masyarakat Talaga Paca merupakan Komunitas Adat Terpencil (KAT) yang tinggal di hutan dengan berburu dan meramu hasil hutan. Pemerintah menyebut masyarakat asli Talaga Paca dengan istilah Tugutil, namun mereka menyebut diri sebagai o hongana ma nyawa yang secara harafiah berarti ‘orang hutan’ atau orang yang berasal dari hutan.

    75% Rumah tangga di Desa Talaga Paca masuk dalam kategori miskin dengan pendapatan per kapita sebesar Rp.300.000 per bulan. Hal ini menjadi sebuah kontradiksi dengan kekayaan alam yang ada di desa berupa hutan, keragaman hayati dan danau yang menjadi sumber air bagi PDAM Halmahera Utara.

    Pada tahun 2019, Menteri Lingkungan Hidup dan Kehutanan memberikan hak kelola terhadap 865 ha kawasan hutan kepada Desa Talaga Paca selama 35 tahun berdasarkan SK.8109/menlhk-pskl/pkps/psl.0/9/2019 dalam bentuk hutan desa sebagai bagian dari program Perhutanan Sosial. Pemberian hak kelola disertai dengan penugasan seorang pendamping bagi Lembaga Pengelola Hutan Desa (LPHD) Talaga Paca.

    Arah pengembangan yang saat ini dilakukan adalah melalui ekowisata. Keterlibatan aktif masyarakat serta dukungan stakeholder menjadi hal yang sangat menentukan berkembangnya ekowisata Talaga Paca guna mewujudkan visi alam Talaga Paca yang lestari dan masyarakatnya yang sejahtera.
    ',

    "atraksi" => [
        "title" => "DESTINASI WISATA DI TALAGA PACA",
		"jungle" => "Jungle Tracking Di Talaga Paca",
